...
from kdit.config import KsanaAttentionBackend
from kdit.config.attention_config import KsanaRadialSageAttentionConfig
from kdit.operations.attention.backends.radial_sage_attn.attn_mask import MaskMap
...
class RadialSageAttentionImpl(KsanaAttentionBackendImpl):
    ...
    def __init__(
        ...
        self.mask_map = None
        from kdit.operations.attention.attention_op import KsanaAttentionOp  # lazy import
