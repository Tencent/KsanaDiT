...
"""Wan 2.1 VACE 14B — PipelineDef 声明（DAG 模式）。
...
_b = PipelineDefBuilder(PipelineKey.Wan2_1_VACE_14B)

# loaders
t5 = _b.add_loader(ModelKey.T5TextEncoder)
dit = _b.add_loader(ModelKey.Wan2_1_VACE_14B)
...
_b.connect(
    ...
    dit.Wan2_1_VACE_14B >> gen.Wan2_1_VACE_14B,
...
WAN_VACE_14B_DEF = register_pipeline_def(_b.keep_tensors(TensorKey.VIDEO).context_builder(WanI2VContextBuilder).build())
