...
from kdit.config import KsanaExperimentalConfig, KsanaFETAConfig, KsanaSLGConfig
from kdit.tensor import TensorKey
from kdit.utils import common_upscale, get_intermediate_device
...
class KsanaWanVaceToVideoNode:
    ...
    FUNCTION = "encode"
    CATEGORY = "kdit/vace"
    DESCRIPTION = "Encodes control video and reference image for Wan VACE video generation using kDiT VAE."
