...
from ..memory.estimator import MODEL_MEMORY_CONFIG, estimate_kdit_model_memory, get_available_memory
...
class KsanaBatchScheduler:
    ...
    def _estimate_memory_for_batch(self, model_key, latent_shape, batch_size: int, run_dtype):
        ...
        memory_required, minimum_required = estimate_kdit_model_memory(
