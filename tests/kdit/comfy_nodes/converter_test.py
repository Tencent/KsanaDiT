...
from kdit.adapter.comfyui.convert import convert_text_embeds_to_kdit


class TestConvertTextEmbedsToKsana(unittest.TestCase):
    """test convert_text_embeds_to_kdit function"""
    ...
    def test(self):
        ...
        positive_result, negative_result = convert_text_embeds_to_kdit(text_embeds)
