...
# Run kdit single-GPU tests.
#
# CI usage (unchanged):
#   bash ci_kdit_single.sh <commit_id> [gpu_cards]
#
# Local usage:
#   bash ci_kdit_single.sh              # auto-detect project root, GPU=1
#   bash ci_kdit_single.sh "" 0         # auto-detect project root, GPU=0
#   KSANA_CI_MODELS_ROOT=/my/models bash ci_kdit_single.sh
