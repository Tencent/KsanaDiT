...
class DCacheConfig(KsanaCacheConfig):
    def __init__(
        ...
        fast_degree,
        slow_degree,
        fast_force_calc_every_n_steps,
        slow_force_calc_every_n_steps,
        skip_first_n_iter=2,
        name: str = None,
    ):
    ...
    def __str__(self):
        return (
            f"DCacheConfig: fast_degree: {self.fast_degree}, slow_degree: {self.slow_degree}, "
...
class TeaCacheConfig(KsanaCacheConfig):
    ...
    def __str__(self):
        return (
            f"TeaCacheConfig: rel_l1_thresh: {self.rel_l1_thresh}, cache_device: {self.cache_device}, "
...
class EasyCacheConfig(KsanaCacheConfig):
    ...
    def __str__(self):
        return (
            f"EasyCacheConfig: reuse_thresh: {self.reuse_thresh}, start_percent: {self.start_percent}, "
...
class MagCacheConfig(KsanaCacheConfig):
    ...
    def __str__(self):
        return (
            f"MagCacheConfig: threshold: {self.threshold}, K: {self.K}, cache_device: {self.cache_device}, "
            f"start_step: {self.start_step}, end_step: {self.end_step}"
        )
