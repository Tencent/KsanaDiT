...
class KsanaModelPool:
    ...
    def update_model(self, model_key: KsanaModelKey, model: KsanaModel, allow_exist=False):
    ...
    def update_models(self, model_tuple_list: list[tuple[KsanaModelKey, KsanaModel]], allow_exist=False):
        for model_key, model in model_tuple_list:
            self.update_model(model_key, model, allow_exist)
