...
def get_sample_scheduler(num_train_timesteps, sampling_steps, sample_solver, device, shift=5.0, denoise=1.0):
    """
    ...
    if sample_solver == "uni_pc":
        ...
        sample_scheduler.set_timesteps(sampling_steps, device=device, denoise=denoise)
